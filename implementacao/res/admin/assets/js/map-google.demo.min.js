...
var handleGoogleMapSetting=function() {
    ...
    function t() {
        var t = {
            zoom: 8, 
            center: new google.maps.LatLng(-8.395368, -37.671242), 
    ...
    $("[data-map-theme]").click(function() {
        ...
        $(f).addClass("active");
        switch(t) {
            case"flat":e.setOptions( {
                styles: r
            });
            break;
            case"turquoise-water":e.setOptions( {
                styles: i
            });
            break;
            case"icy-blue":e.setOptions( {
                styles: s
            });
            break;
            case"cobalt":e.setOptions( {
                styles: u
            });
            c = true;
            break;
            case"old-dry-mud":e.setOptions( {
                styles: o
            });
            break;
            case"dark-red":e.setOptions( {
                styles: a
            });
            c = true;
            break;
            default:e.setOptions( {
                styles: n
            });
            break
        }
