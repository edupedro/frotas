    ...
    $("#jstree-checkable").jstree( {
        plugins:["wholerow", "checkbox", "types"], core: {
            ...
            , data:[ {
                ...
                , {
                    text:"initially open", icon:"fa fa-folder fa-lg", state: {
                        opened: !0
                    }
                    , children:[ {
                        text: "Another node"
    ...
    $("#jstree-drag-and-drop").jstree( {
        core: {
            ...
            , check_callback:!0, data:[ {
                ...
                , {
                    text:"Initially open", icon:"fa fa-folder text-success fa-lg", state: {
                        opened: !0
                    }
                    , children:[ {
                        text: "Disabled node", disabled: !0
                    }
                    , {
                        text: "Another node"
                    }
                ...
                , {
                    text:"Sub Nodes", icon:"fa fa-folder text-danger fa-lg", children:[ {
...
handleJstreeAjax=function() {
    $("#jstree-ajax").jstree( {
        core: {
            ...
            , check_callback:!0, data: {
                url:function(e) {
                    return"#"===e.id?"assets/plugins/jstree/data_root.json": "assets/plugins/jstree/"+e.original.file
                }
                , data:function(e) {
                    return {
                        id: e.id
