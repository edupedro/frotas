...
var green = "#00acac",
    ...
    checkSwitcherState = function() {
        ...
        $('[data-change="check-switchery-state-atendido1"]').live("change", function() {
        	if($(this).prop("checked") == true){
                $('[data-id="switchery-state-text1"]').text("Sim")        		
        	}else{
                $('[data-id="switchery-state-text1"]').text("Não")        		        		
        	}
        }), 
        $('[data-change="check-switchery-state-atendido2"]').live("change", function() {
        	if($(this).prop("checked") == true){
                $('[data-id="switchery-state-text2"]').text("Sim")        		
        	}else{
                $('[data-id="switchery-state-text2"]').text("Não")        		        		
        	}
        })
    },
