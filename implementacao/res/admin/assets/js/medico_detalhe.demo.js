...
radarChartData= {
    ...
    "Sem dados"],
    datasets:[ {
        label: "My First dataset", fillColor: "rgba(45,53,60,0.2)", strokeColor: "rgba(45,53,60,1)", pointColor: "rgba(45,53,60,1)", pointStrokeColor: "#fff", pointHighlightFill: "#fff", pointHighlightStroke: "rgba(45,53,60,1)", data: [65, 59, 90, 81, 56, 55, 40]
    }
    ,
    {
        label: "My Second dataset", fillColor: "rgba(52,143,226,0.2)", strokeColor: "rgba(52,143,226,1)", pointColor: "rgba(52,143,226,1)", pointStrokeColor: "#fff", pointHighlightFill: "#fff", pointHighlightStroke: "rgba(52,143,226,1)", data: [28, 48, 40, 19, 96, 27, 100]
    }
    ]
}
,
...
var handleGenerateGraph=function(l) {
    ...
    */
    var b=document.getElementById("radar-chartI").getContext("2d"),
    i=(new Chart(b).Radar(radarChartDataI, {
        animation: l
    }));
